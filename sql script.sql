...
use shop;
create table user (id INT NOT NULL AUTO_INCREMENT, email VARCHAR(30) NOT NULL, password VARCHAR(30) NOT NULL, name VARCHAR(50) NOT NULL,  region VARCHAR(30) NOT NULL, PRIMARY KEY (id));
